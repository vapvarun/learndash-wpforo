			...
			<div class="wbcom-welcome-support-info">
				...
				<div class="wbcom-support-info-wrap">
					<div class="wbcom-support-info-widgets">
						...
						<a href="<?php echo esc_url( 'https://wbcomdesigns.com/docs/learndash-addons/learndash-wpforo/' ); ?>" class="button button-primary button-welcome-support" target="_blank"><?php esc_html_e( 'Read Documentation', 'learndash-wpforo' ); ?></a>
						</div>
					</div>
