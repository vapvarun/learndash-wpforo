...
{
    include_once plugin_dir_path(__FILE__) . 'includes/class-learndash-wpforo-activator.php';
...
{
    include_once plugin_dir_path(__FILE__) . 'includes/class-learndash-wpforo-deactivator.php';
